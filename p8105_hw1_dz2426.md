...
Comment 1: <br /> The mean of the random sample is -0.2. <br /> The mean
of the logic vector is 0.38. <br /> The mean of the character vector is
...
```
    ...
    ## [1] 0.0000000 0.0000000 0.0000000 1.6314314 0.0000000 2.6121077 0.0000000
    ## [8] 0.2607304
...
```
    ...
    ## [1] -0.9702213 -2.6442266 -0.9949547  3.2628628 -1.1109284  5.2242154
    ## [7] -0.3795574  0.5214608
...
<br /> The mean, median and standard deviation of x are -0.01, 0.04 and
0.98, respectively. <br /> The proportion of cases for which x+y\>1 is
0.23.
...
legend("bottomright", pch = 1, col = c("blue","red"), 
       legend = c("FALSE","TRUE"))
```
