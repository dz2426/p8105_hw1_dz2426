...
The size of the data set is `r nrow(df_2)` and `r ncol(df_2)`.
The mean, median and standard deviation of x is `r round(mean_x, digits = 2)`, `r round(median_x, digits = 2)` and `r round(sd_x, digits = 2)`, respectively.
