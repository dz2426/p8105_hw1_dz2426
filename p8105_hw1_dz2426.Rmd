...
In general, this shows that only the numeric and logical vectors can show their mean values, and explains why the character and factor variables did not show their means.
