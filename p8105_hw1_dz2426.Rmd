...
```
Comment 3: <br />
In line with the value of the proportion of cases for which x+y>1, these three scatterplots clearly show that there is a much higher chance to obtain x+y<1 (red dots). On each plot, it also shows that with higher x and y values (blue dots), it is more likely to get a 'TRUE' result (x+y>1).
